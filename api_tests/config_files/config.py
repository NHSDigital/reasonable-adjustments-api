...
REASONABLE_ADJUSTMENTS_UNDERLYINGCONDITIONLIST = f"{REASONABLE_ADJUSTMENTS_BASE_URL}/{REASONABLE_ADJUSTMENTS_PROXY_PATH}/UnderlyingConditionList"
...
REASONABLE_ADJUSTMENTS_STATUS = f"{REASONABLE_ADJUSTMENTS_BASE_URL}/{REASONABLE_ADJUSTMENTS_PROXY_PATH}/_status"
REASONABLE_ADJUSTMENTS_PING = f"{REASONABLE_ADJUSTMENTS_BASE_URL}/{REASONABLE_ADJUSTMENTS_PROXY_PATH}/_ping"

# Test Patient Details
TEST_PATIENT_NHS_NUMBER = '9693892283'
TEST_NHSD_SESSION_URID = '093895563513'

# Status endpoint
STATUS_APIKEY = ENV['status']['status_apikey']
...
ENDPOINTS = {
    ...
    'UnderlyingConditionList': REASONABLE_ADJUSTMENTS_UNDERLYINGCONDITIONLIST,
